        ...
        return (
            <SafeAreaView style={Styles.MainView}>
                ...
                <ImageBackground style={{ width: '100%', height: Diem.height * 0.64 }} source={require('../Assets/Layer8570.png')}>
                    ...
                    <View style={{ height: Diem.height * 0.18, width: Diem.width, justifyContent: 'center', alignItems: 'center' }}>
                        <Text style={{ width: '85%', fontSize: FontSize.medium.fontsize, textAlign: 'center', lineHeight: 40 }}>{Strings.reviewAndConsultCon}</Text>
                    </View>

                    <View style={Styles.GRDTCon}>
                        <TouchableOpacity activeOpacity={0.4} style={Styles.GRDTBtn2}>
...
export default connect(mapToStateProps)(ReviewConsult);
